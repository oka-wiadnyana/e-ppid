...
<form action="" id="form-tambah-link">
    ...
    <div class="row">
        <div class="col">
            <h3><i class="fas fa-tachometer-alt mr-2"></i>TAMBAH LAYANAN ELEKTRONIK</h3>
        </div>
...
<script>
    ...
    $('#form-tambah-link').submit(function(e) {
        ...
        $.ajax({
            type: "post",
            url: "<?= base_url('admineppid/insert_layanan_elektronik'); ?>",
            data: $(this).serialize(),
            dataType: "json",
            beforeSend: function() {
            ...
            success: function(response) {
                if (response.msg == 'success') {
                    ...
                    $(location).attr('href', '<?= base_url('admineppid/tambah_layanan_elektronik'); ?>')
                }
            }
        });
    })
