...
-- Dumping data for table eppid.link_informasi: 49 rows
...
INSERT INTO `profil_satker` (`id`, `nama`, `nama_pendek`, `alamat`, `nomor_telepon`, `nomor_fax`, `email`, `link_satker`, `link_youtube`, `link_facebook`, `link_instagram`, `link_twitter`, `link_video_dashboard`, `logo`, `created_at`, `updated_at`, `deleted_at`) VALUES
	(3, 'PENGADILAN NEGERI BANGLI', 'PN BANGLI', 'Jl. Mayor Sugianyar No. 61, Bangli, Bali', '(0366) 91030', '(0366) 91030', 'onsdee86@gmail.com', 'https://pn-bangli.go.id', 'https://www.youtube.com/channel/UCLeee8y1JAEroAGxv', 'https://www.facebook.com/pengadilan.negeribangli.5', 'https://www.instagram.com/pnbangli/', '', '0Akcjvjgaw4', 'logo-pn.png', NULL, NULL, NULL);
